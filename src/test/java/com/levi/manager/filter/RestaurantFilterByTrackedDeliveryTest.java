...
@ActiveProfiles("test")
public class RestaurantFilterByTrackedDeliveryTest {

    @InjectMocks
    private RestaurantFilterByTrackedDelivery filter;
    ...
    @Test
    public void filterRestaurantSearchingWithoutTrackedDelivery() {
    ...
    @Test
    public void filterRestaurantSearchingWithTrackedDelivery() {
        List<FilteredRestaurantDTO> beginFilteredRestaurants = givenFilteredRestaurants();
        List<FilteredRestaurantDTO> filteredRestaurants = filter.filterRestaurant(givenRestaurantSearchDTO(), beginFilteredRestaurants);
        Assert.assertTrue(filteredRestaurants.get(FIRST_RESTAURANT).isHasTrackedDelivery());
    }
    ...
    private List<FilteredRestaurantDTO> givenFilteredRestaurants() {
        ...
        firstFilteredRestaurant.setHasTrackedDelivery(true);
        ...
        secondFilteredRestaurant.setHasTrackedDelivery(true);
    ...
    private RestaurantSearchDTO givenRestaurantSearchDTO() {
        ...
        restaurantSearchDTO.setHasTrackedDelivery(true);
