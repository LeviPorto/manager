...
@ActiveProfiles("test")
public class RestaurantFilterByDeliveryFeeTest {

    @InjectMocks
    private RestaurantFilterByDeliveryFee filter;
    ...
    @Test
    public void filterRestaurantSearchingWithoutDeliveryFee() {
    ...
    public void filterRestaurantSearchingWithCategory() {
        ...
        Assert.assertEquals(filteredRestaurants.get(FIRST_RESTAURANT).getDeliveryFee(), SECOND_RESTAURANT_DELIVERY_FEE);
    }
    ...
    private List<FilteredRestaurantDTO> givenFilteredRestaurants() {
        ...
        firstFilteredRestaurant.setDeliveryFee(FIRST_RESTAURANT_DELIVERY_FEE);
        ...
        secondFilteredRestaurant.setDeliveryFee(SECOND_RESTAURANT_DELIVERY_FEE);
    ...
    private RestaurantSearchDTO givenRestaurantSearchDTO() {
        ...
        restaurantSearchDTO.setDeliveryFee(SEARCHED_DELIVERY_FEE);
