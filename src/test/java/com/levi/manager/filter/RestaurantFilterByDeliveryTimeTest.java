...
@ActiveProfiles("test")
public class RestaurantFilterByDeliveryTimeTest {

    @InjectMocks
    private RestaurantFilterByDeliveryTime filter;
    ...
    private final Double FIRST_RESTAURANT_DELIVERY_FEE = 18.0;
    ...
    private final Double SECOND_RESTAURANT_DELIVERY_FEE = 15.0;

    private final Double SEARCHED_DELIVERY_FEE = 16.0;

    @Test
    public void filterRestaurantSearchingWithoutDeliveryTime() {
    ...
    public void filterRestaurantSearchingWithCategory() {
        ...
        Assert.assertEquals(filteredRestaurants.get(FIRST_RESTAURANT).getDeliveryTime(), SECOND_RESTAURANT_DELIVERY_FEE);
    }
    ...
    private List<FilteredRestaurantDTO> givenFilteredRestaurants() {
        ...
        firstFilteredRestaurant.setDeliveryTime(FIRST_RESTAURANT_DELIVERY_FEE);
        ...
        secondFilteredRestaurant.setDeliveryTime(SECOND_RESTAURANT_DELIVERY_FEE);
    ...
    private RestaurantSearchDTO givenRestaurantSearchDTO() {
        ...
        restaurantSearchDTO.setDeliveryTime(SEARCHED_DELIVERY_FEE);
