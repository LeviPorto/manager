...
@ActiveProfiles("test")
public class RestaurantFilterByIFoodDeliveryTest {

    @InjectMocks
    private RestaurantFilterByIFoodDelivery filter;
    ...
    @Test
    public void filterRestaurantSearchingWithoutIFoodDelivery() {
    ...
    @Test
    public void filterRestaurantSearchingWithIFoodDelivery() {
        List<FilteredRestaurantDTO> beginFilteredRestaurants = givenFilteredRestaurants();
        List<FilteredRestaurantDTO> filteredRestaurants = filter.filterRestaurant(givenRestaurantSearchDTO(), beginFilteredRestaurants);
        Assert.assertTrue(filteredRestaurants.get(FIRST_RESTAURANT).isIFoodDelivery());
    }
    ...
    private List<FilteredRestaurantDTO> givenFilteredRestaurants() {
        ...
        firstFilteredRestaurant.setIFoodDelivery(true);
        ...
        secondFilteredRestaurant.setIFoodDelivery(true);
    ...
    private RestaurantSearchDTO givenRestaurantSearchDTO() {
        ...
        restaurantSearchDTO.setIFoodDelivery(true);
