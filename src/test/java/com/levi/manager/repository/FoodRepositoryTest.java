...
public class FoodRepositoryTest {
    ...
    public void findByRestaurantId() {
        repository.save(givenFirstFood());
        repository.save(givenSecondFood());
        List<Food> foodsByRestaurant = repository.findByRestaurantId(RESTAURANT_ID);
        Assert.assertEquals(foodsByRestaurant.get(COMBO).getId(), RESTAURANT_ID);
    }

    private Food givenFirstFood() {
        Food food = new Food();
        Restaurant restaurant = givenFirstRestaurant();
        restaurantRepository.save(restaurant);
        food.setRestaurant(restaurant);
        food.setName(COMBO_NAME);
        food.setPrice(COMBO_PRICE);
        food.setCategory(COMBO_FOOD_CATEGORY);
        return food;
    }

    private Food givenSecondFood() {
        Food food = new Food();
        Restaurant restaurant = givenSecondRestaurant();
        restaurantRepository.save(restaurant);
        food.setRestaurant(restaurant);
        food.setName(SECOND_COMBO_NAME);
        food.setPrice(SECOND_COMBO_PRICE);
        food.setCategory(SECOND_COMBO_FOOD_CATEGORY);
        return food;
    }
